...
if __name__ == '__main__':
    ...
    adj_sld = SLDQuantStopping(target_recall=0.9, nstd=0., dataset_length=pool_size, alpha=0)
    ...
    run_al(dataset.target_names[classes[1]], pool_size, copy.deepcopy(x), copy.deepcopy(y[:, classes[0]]), pool_size,
